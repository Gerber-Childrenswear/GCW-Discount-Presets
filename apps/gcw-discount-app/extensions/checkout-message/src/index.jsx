...
// Hyper theme reference from theme assets:
// .free-shipping-goal { color: rgb(var(--color-progress-bar)); }
// .progress-bar { height: 0.7rem; border-radius: 3rem; background: rgba(foreground, .075); }
